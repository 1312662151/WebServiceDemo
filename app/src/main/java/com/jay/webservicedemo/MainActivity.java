...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //天气查询相关参数
    private static final String Weatherurl = "http://www.webxml.com.cn/WebServices/WeatherWebService.asmx?wsdl";
    private static final String Weathermethod = "getSupportCity";//改为支持地
    private static final String WeathersoapAction = "http://WebXml.com.cn/getSupportCity";
    //归属地查询相关参数
...
//                break;
    ...
    public void getWether() {
        ...
        soapObject.addProperty("byProvinceName", edit_param.getText().toString());
